...
eq('a checkout in someone else\'s home',
  stackRootFrom([svc('bothy-files', [bind('/Users/ada/src/bothy', '/repos/stacks')])]),
  '/Users/ada/src/bothy/');

eq('a trailing slash is added, never doubled',
  stackRootFrom([svc('bothy-files', [bind('/srv/bothy/', '/repos/stacks')])]),
  '/srv/bothy/');
...
const ROOT = stackRootFrom([svc('bothy-files', [bind('/home/ada/stacks', '/repos/stacks')])]);
