...
// read here, so it does not get a peer slot - but `bothy-files` genuinely can,
...
export function Overview() {
  ...
  //
  // The argument is not aesthetic. You are reading this page THROUGH bothy-web,
  ...
  // than a deletion: `bothy-files` can be down while this page renders
