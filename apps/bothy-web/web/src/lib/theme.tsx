...
// The portal-* key strings survive the 2026-09 bothy rename ON PURPOSE: renaming them would wipe every saved theme.
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  // User themes: .css files dropped into apps/bothy-web/data/themes on the
