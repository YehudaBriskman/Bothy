...
export async function backupsMock(): Promise<BackupsResult> {
  ...
  return {
    ...
    sets: [
      { name: 'env', managed: true, what: 'Copies of .env - every credential, in plaintext.', keep: 14, readable: true, mode: '700', count: 14, bytes: 25_256, newest: { name: 'env-20260917-030008', at: ago(day * 0.35), bytes: 1804 }, oldest: { name: 'env-20260904-030001', at: ago(day * 13.3), bytes: 1790 } },
      { name: 'grafana', managed: true, what: 'grafana.db - dashboards, users, alert state.', keep: 14, readable: true, mode: '700', count: 14, bytes: 40_886_272, newest: { name: 'grafana-20260917-030008.db', at: ago(day * 0.35), bytes: 2_920_448 }, oldest: { name: 'grafana-20260904-030001.db', at: ago(day * 13.3), bytes: 2_899_968 } },
      { name: 'postgres', managed: true, what: 'pg_dumpall of every database, keycloak included (users and password hashes).', keep: 14, readable: true, mode: '700', count: 14, bytes: 972_763, newest: { name: 'pg-20260917-030008.sql.gz', at: ago(day * 0.35), bytes: 69_491 }, oldest: { name: 'pg-20260904-030001.sql.gz', at: ago(day * 13.3), bytes: 68_100 } },
      { name: 'victoriametrics', managed: true, what: 'A snapshot of every metric (15 days), as a tar.', keep: 3, readable: true, mode: '700', count: 3, bytes: 1_283_457_024, newest: { name: 'vm-20260917-030008.tar', at: ago(day * 0.35), bytes: 427_819_008 }, oldest: { name: 'vm-20260915-030001.tar', at: ago(day * 2.35), bytes: 427_819_008 } },
