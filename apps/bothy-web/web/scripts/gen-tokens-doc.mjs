...
const GROUPS = [
  ...
  ['Shape', (k) => /^--(r-|border-w|disabled-opacity|rest-opacity|quiet-opacity)/.test(k), ''],
  ...
  ['Loader', (k) => /^--loader-/.test(k), 'Mirrored as `LOADER` in `components/ui/Loader.tsx`. The orb has three tuned designs (20, 32, 64), not a scale. See [feedback](../patterns/feedback.md#loading).'],
