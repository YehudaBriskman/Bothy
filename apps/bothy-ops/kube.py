...
Lock 3 holds if 1 and 2 are both wrong: a total compromise of this process
yields a token that can restart, scale and read logs in two dev namespaces - not
a shell, not a secret, not the cluster.
