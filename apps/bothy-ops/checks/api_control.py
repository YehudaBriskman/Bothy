...
AUDIT = os.path.join(tempfile.mkdtemp(prefix="bothy-ops-api-control-"), "actions.log")
...
STATE = {
    ...
    "traefik": "running",
    "bothy-ops": "running",
    "bothy-socket-read": "running",
    "bothy-socket-write": "running",
    "already-up": "running",
    "sleeper": "exited",
}
...
control.DOCKER_READ = control.DOCKER_WRITE = serve(Fake)
...
STATE["bothy-socket-read"] = "exited"
code, r = post("start", {"container": "bothy-socket-read"})
