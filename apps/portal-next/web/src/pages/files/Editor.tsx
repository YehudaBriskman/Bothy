...
import {
  ...
  FileDown, GitCommitVertical, Info, Keyboard, LoaderCircle, Lock, LogIn, Pencil,
  Save, Search, Undo2, X,
} from 'lucide-react';
import {
 ...
 *
 *  This mirrors DocBody's order and has to move with it. Written once, beside
 *  it, rather than re-derived at each use. */
...
function DocBody({
  doc, plain, onFail, onRetryOpen, setDraft, onStat, onDownload, canDownload, onFallback, editorRef,
}: {
  doc: Doc;
  plain: boolean;
  onFail: () => void;
...
export function Editor({
  ...
  onDownload, onArchive, onReveal, canDownload, onFallback, handleFor,
}: {
