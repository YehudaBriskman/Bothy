...
apps/bothy-files/compose.yml already mounts, deliberately. If a name here
...
#
# .../apps/bothy-files/checks/env.py -> checks -> bothy-files -> apps -> root,
...
#
# This is the same argument apps/bothy-files/compose.yml makes for mounting
...
# ---------------------------------------------------------------------------
# Host paths. Every name below is the one apps/bothy-files/compose.yml already
...
AUDIT_LOG = os.path.join(STACKS, "apps", "bothy-files", "audit", "writes.log")
