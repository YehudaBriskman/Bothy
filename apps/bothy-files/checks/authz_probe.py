...
Traefik's runtime router table and asserts which middleware each bothy-files
...
for name, want in (("bothy-files-read@file", "sso-viewer@file"),
                   ("bothy-files-write@file", "sso-editor@file"),
                   ("bothy-files-delete@file", "sso-editor@file")):
    r = routers.get(name)
